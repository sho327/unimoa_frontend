...
const projectSchema = z.object({
    ...
    deadline: z.date({ message: "締め切りは必須です。" }),
    tags: z.array(z.string()),
});

type ProjectFormValues = z.infer<typeof projectSchema>;

const FormDatePicker = ({ name, label }: { name: "deadline"; label: string }) => {
    ...
    return (
        <div>
            ...
            <DateInput
                ...
                error={error && (
                    <span className="text-[11px] font-bold text-error mt-1 block">
                        {error.message}
                    </span>
                )}
                value={field.value}
                ...
                // 必要に応じてスタイルを調整してください
                size="md"
                radius="md" // または物理的に指定したい場合は classNames で
                classNames={{
                    input: `
                        bg-white 
                        border-gray-200 
                        ...
                        text-base 
                        h-12                /* 他のinputの高さ(h-12)に合わせる */
                        rounded-2xl         /* 他のinputの丸みに合わせる */
                        font-bold           /* ★ここを追加: フォントを太くする */
                        text-neutral        /* テキスト色 */
                        ${error ? "!border-error" : ""}
                    `,
                }}
            ...
            <form 
                ...
                <div className="bg-white rounded-2xl p-6 sm:p-10 space-y-10 shadow-sm border border-gray-100">
                    ...
                    <section className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        ...
                        <FormDatePicker name="deadline" label="応募締め切り" />
                        <TagInput name="tags" />
                    </section>
