    ...
    return (
        <header className="bg-white border-b border-gray-100 h-16 px-5 shrink-0 z-[120] flex items-center justify-between">
            <div className="flex items-center gap-2 flex-1">
                ...
                <div className="lg:block hidden relative">
                    <button
                        ...
                        className="flex items-center gap-1 h-10 w-[225px] min-w-[225px] px-3 border border-gray-200 hover:border-[oklch(0.73_0.11_162)]/50 rounded-lg bg-white text-gray-900/90 font-semibold"
                    >
                    ...
                    {spaceDropdownOpen && (
                        <div className="absolute top-full mt-2 w-full bg-white border border-gray-100 rounded-lg shadow-2xl z-50">
                            <ul className="py-2">
                                {spaces.map((space) => (
                                    <li key={space.id}>
                                        <button
                                            ...
                                            className={`w-full text-left px-4 py-2 hover:bg-[oklch(0.73_0.11_162)]/10 flex items-center justify-between ${space.id === activeSpace.id ? "bg-[oklch(0.73_0.11_162)]/10 text-[oklch(0.73_0.11_162)] font-bold" : ""
                                                }`}
                                        >
                                ...
                                <li>
                                    <button className="w-full text-left px-4 py-2 hover:bg-[oklch(0.73_0.11_162)]/10 text-sm">新しいチームを作成</button>
                                </li>
                            </ul>
                        </div>
                    )}
            ...
            <div className="flex items-center gap-3 flex-none">
                ...
                {/* プロフィール */}
                <div className="relative group">
                    <div role="button" className="avatar h-8 w-8 rounded-full border-2 border-gray-100 overflow-hidden cursor-pointer hover:border-[oklch(0.73_0.11_162)]/40 transition-all">
                    ...
                    <ul className="hidden group-hover:block absolute right-0 top-full mt-2 w-56 bg-white border border-gray-100 rounded-2xl shadow-2xl p-2 z-[120]">
                        ...
                        <li><button className="w-full text-left px-4 py-2 hover:bg-gray-50 rounded-lg text-sm font-bold text-gray-600">プロフィール設定</button></li>
                        <div className="border-t border-gray-100 my-1 opacity-50" />
                        <li><button className="w-full text-left px-4 py-2 hover:bg-red-50 text-red-500 rounded-lg text-sm font-bold">ログアウト</button></li>
                    </ul>
                </div>
            </div>
        </header>
