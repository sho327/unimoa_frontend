            ...
            {isOpen && (
                <div className="absolute top-full right-0 mt-2 w-56 bg-white border border-gray-100 rounded-2xl shadow-2xl z-[150] overflow-hidden animate-in fade-in zoom-in-95 duration-100">
                    ...
                    <div className="px-4 py-3 border-b border-gray-50 bg-gray-50/30">
                        <p className="text-xs font-black text-gray-900 truncate leading-none mb-1">{displayUserName}</p>
                        <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest leading-none">管理者</p>
                    </div>
                    ...
                    <div className="py-1.5 px-1.5">
                        <Link
                            ...
                            className="flex items-center gap-2.5 px-3 py-2.5 text-sm font-bold text-gray-600 hover:bg-gray-50 hover:text-gray-900 rounded-xl transition-all group"
                        >
