                        ...
                        <div className="bg-white border-b border-gray-100 px-4 py-2 shrink-0 z-[100] flex items-center justify-between min-h-[56px] shadow-sm">
                            <div className="flex items-center gap-3">
                                <div className="flex flex-col min-w-0 min-h-[40px] justify-center px-1">
                                    <span className="text-[11px] font-black text-[oklch(0.73_0.11_162)]/70 uppercase tracking-widest leading-none mb-1">
                                        スペース
                                    </span>
                                    <h2 className="text-[14px] font-black truncate text-gray-900 max-w-[150px] sm:max-w-xs">
                                        {activeSpace.name}
                                    </h2>
                                </div>
                            </div>
