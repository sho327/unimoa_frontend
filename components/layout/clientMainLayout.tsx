...
export const useLayoutContext = () => {
    ...
    if (!context) {
        throw new Error("useLayoutContext must be used within a ClientMainLayout");
    }
    return context;
};
...
export default function ClientMainLayout({
    ...
    const [activeSpace, setActiveSpace] = useState<Space>(DEFAULT_SPACES[0]);
    const [spaceDropdownOpen, setSpaceDropdownOpen] = useState(false);
    const [mobileTeamMenuOpen, setMobileTeamMenuOpen] = useState(false); // スマホ用チームメニュー開閉
